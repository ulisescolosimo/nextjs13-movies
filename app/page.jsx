...
export default function Home() {
  return (
    <>
      <section className="dark:bg-gray-900 dark:text-gray-100 rounded-xl">
        <div className="container flex flex-col justify-center p-6 mx-auto flex-wrap sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
          <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
            <h1 className="text-2xl font-bold leading-none md:text-6xl">
              Ac mattis
              <span className="dark:text-yellow-500">senectus</span>erat
              pharetra
            </h1>
            ...
            <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
              <a
                ...
                href="#"
                className="px-8 py-3 text-lg font-semibold rounded dark:bg-yellow-500 dark:text-gray-900"
              >
                Suspendisse
              </a>
              <a
          ...
          <div className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
            <img
              src="https://wallpaperaccess.com/full/2000044.png"
              alt=""
              className="rounded-xl object-cover h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128 dark:bg-gray-500"
            />
          </div>
        </div>
      </section>
      ...
      <section className="my-10">
        <span className="block mb-2 text-xs font-medium tracking-widest uppercase lg:text-center dark:text-yellow-500">
          How it works
        </span>
        ...
        <div className="grid gap-6 my-16 lg:grid-cols-3">
          <div className="flex flex-col p-8 space-y-4 rounded-md dark:bg-gray-900">
            <div className="flex items-center justify-center flex-shrink-0 w-12 h-12 text-xl font-bold rounded-full bg-yellow-500 text-gray-900">
              1
            </div>
      ...
      <section className="py-6 dark:bg-gray-900 dark:text-gray-50 rounded-lg">
	<div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
		<div className="flex flex-col justify-center lg:text-left">
			<p className="mb-1 text-sm font-medium tracking-widest uppercase text-yellow-500">Hic eligendi necessitatibus quod quia</p>
		...
		<div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
			<button className="inline-flex items-center px-6 py-3 rounded-lg dark:bg-yellow-500 dark:text-gray-900">
			...
			<button className="inline-flex items-center px-5 py-3 rounded-lg dark:bg-yellow-500 dark:text-gray-900">
